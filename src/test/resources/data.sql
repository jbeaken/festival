...
insert into festival_website (id, name, year, is_live,
  ...
  (1, '2019', 2019, true,
   ...
   'Your Marxism Booking Confirmation', '<p>You can follow us on <a href="https://www.facebook.com/events/1147513575415066/" target="_blank">facebook</a>,&nbsp;<a href="https://twitter.com/MarxismFestival" target="_blank">twitter</a> and <a href="https://www.instagram.com/festival_festival/" target="_blank">instagram</a> for the latest updates about the event.</p><p>Marxism Festival starts on Thursday 4 July and finishes on Sunday 7 July.</p><p>Your ticket will be sent to you in the post nearer the event.</p><p>We will be announcing the exciting new London venue for this year’s event very soon - watch this space!</p><p>If you need any more information please get in touch with us on&nbsp;<a href="mailto:info@festivalfestival.org.uk" target="_blank">info@festivalfestival.org.uk</a>&nbsp;or call 020 7840 5620.</p>',
   20, 30, 30, 55,
   10, 15, 15, 20,
   10, 15, 15, 20,
   'Marxism Festival 2019', 'PO BOX 74955', 'London', 'E16 9EJ', 'info@festivalfestival.org.uk', '020 7840 5620', 'Get in touch with us', 'Do not hesitate to drop us a line. Tel : 020 7840 5620',
...
"<h1 class='text-center font-lindham'>Marxism Festival is an annual event hosted by the Socialist Workers Party</h1><div class='row'><div class='col-xs-12'><p>The Marxism Festival has been taking place for over 30 years. Our aim is to provide a forum to discuss and debate left wing politics involving speakers and activists from different organisations as well as the party.</p><p>The festival brings together thousands of activists, trade unionists, students, writers and academics from across the globe to grapple with political questions of the day and discuss a way forward in campaigns and struggles.</p><p>Find your local <a href='http://socialistworker.co.uk/public/events' target='_blank'>party branch</a></p><p>Please visit our <a href='http://party.org.uk' target='_blank'>website</a></p></div><h3 class='text-center'>Read Socialist Workers Party publications online</h3><div class='row'><div class='col-sm-3'><a href='https://socialistworker.co.uk' target='_blank'><img class='img-responsive img-cover' src='/img/modal/sw-cover.jpg'/></a></div><div class='col-sm-3'><a href='http://isj.org.uk/' target='_blank'><img class='img-responsive img-cover' src='/img/modal/isj-cover.jpg'/></a></div><div class='col-sm-3'><a href='http://socialistreview.org.uk/' target='_blank'><img class='img-responsive img-cover' src='/img/modal/rw-cover.jpg'/></a></div><div class='col-sm-3'><a href='https://www.youtube.com/user/partytvuk' target='_blank'><img class='img-responsive img-cover' src='/img/modal/party-tv.gif'/></a></div></div><hr/><div class='row'><div class='col-xs-4 social-container'><a class='twitter social-icon' target='_blank' title='party on Twitter' href='https://twitter.com/socialistworker'><ion-icon name='logo-twitter'></ion-icon></a></div><div class='col-xs-4 social-container'><a class='facebook social-icon' target='_blank' title='party on Facebook' href='https://www.facebook.com/SocialistWorkerBritain/'><ion-icon name='logo-facebook'></ion-icon></a></div><div class='col-xs-4 social-container'><a class='instagram social-icon' target='_blank' title='party on Youtube' href='https://www.youtube.com/user/partytvuk'><ion-icon name='logo-youtube'></ion-icon></a></div></div>",
'/img/modal/party3.jpg',
'admin', now());

insert into festival_website_about (festival_website_id, abouts_id, about_item_index) values (1, 1, 0);
insert into festival_website_about (festival_website_id, abouts_id, about_item_index) values (1, 2, 1);
insert into festival_website_about (festival_website_id, abouts_id, about_item_index) values (1, 3, 2);
insert into festival_website_about (festival_website_id, abouts_id, about_item_index) values (1, 4, 3);
insert into festival_website_about (festival_website_id, abouts_id, about_item_index) values (1, 5, 4);
insert into festival_website_about (festival_website_id, abouts_id, about_item_index) values (1, 6, 5);
insert into festival_website_about (festival_website_id, abouts_id, about_item_index) values (1, 7, 6);
insert into festival_website_about (festival_website_id, abouts_id, about_item_index) values (1, 8, 7);
insert into festival_website_about (festival_website_id, abouts_id, about_item_index) values (1, 9, 8);
...
insert into carousel_item (id, name, text, image_url, creator, date_created)
values (7, '7', 'A festival of <span>socialist ideas</span>', 'imageUrl', 'admin', now());

insert into festival_website_carousel_items (festival_website_id, carousel_items_id, carousel_item_index) values (1, 1, 0);
insert into festival_website_carousel_items (festival_website_id, carousel_items_id, carousel_item_index) values (1, 2, 1);
insert into festival_website_carousel_items (festival_website_id, carousel_items_id, carousel_item_index) values (1, 3, 2);
insert into festival_website_carousel_items (festival_website_id, carousel_items_id, carousel_item_index) values (1, 4, 3);
insert into festival_website_carousel_items (festival_website_id, carousel_items_id, carousel_item_index) values (1, 5, 4);
insert into festival_website_carousel_items (festival_website_id, carousel_items_id, carousel_item_index) values (1, 6, 5);
insert into festival_website_carousel_items (festival_website_id, carousel_items_id, carousel_item_index) values (1, 7, 6);
...
insert into speaker (id, name, short_description, long_description, creator, date_created)
values (17, 'Mark Perryman', 'Mark is a founder of Philosophy Football and editor of The Corbyn Effect. He&apos;ll be debating <b>Corbyn and the future of British politics</b> with Mark L Thomas from the party.', null,
'admin', now());
...
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 1, 0);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 2, 1);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 3, 2);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 4, 3);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 5, 4);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 6, 5);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 7, 6);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 8, 7);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 9, 8);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 10, 9);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 11, 10);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 12, 11);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 13, 12);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 14, 13);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 15, 14);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 16, 15);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 17, 16);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 18, 17);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 19, 18);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 20, 19);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 21, 20);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 22, 21);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 23, 22);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 24, 23);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 25, 24);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 26, 25);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 27, 26);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 28, 27);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 29, 28);
insert into festival_website_speakers (festival_website_id, speakers_id, speaker_index) values (1, 30, 29);
...
insert into festival_website_themes (festival_website_id, themes_id, theme_index) values (1, 1, 0);
insert into festival_website_themes (festival_website_id, themes_id, theme_index) values (1, 2, 1);
insert into festival_website_themes (festival_website_id, themes_id, theme_index) values (1, 3, 2);
insert into festival_website_themes (festival_website_id, themes_id, theme_index) values (1, 4, 3);
insert into festival_website_themes (festival_website_id, themes_id, theme_index) values (1, 5, 4);
insert into festival_website_themes (festival_website_id, themes_id, theme_index) values (1, 6, 5);
insert into festival_website_themes (festival_website_id, themes_id, theme_index) values (1, 7, 6);
insert into festival_website_themes (festival_website_id, themes_id, theme_index) values (1, 8, 7);
insert into festival_website_themes (festival_website_id, themes_id, theme_index) values (1, 9, 8);
