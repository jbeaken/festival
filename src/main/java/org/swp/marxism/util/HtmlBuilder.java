...
>>>>>>> d9a4772... Themes now ready to show meetings, speakers.sql added
		...
		String venueText = getVenueText( meeting );

		// Add class to title which media queries will style, e.g. using font-size : 1.0rem
		...
		builder.append("<div class='meetings__item__title'>" + title + "</div>");
		...
		builder.append("<div class='meetings__item__venue'>" + venueText + "</div>");
